...
const COLOR_SENSOR = "color-sensor";
...
Components.sunlight = require("./blokdots_sunlight");
Components.colorSensor = require("./blokdots_colorSensor");
  ...
  TCS3472: {
    ...
    initialize: {
      value(board, options) {
        ...
        // "shutter time"
        const integrationTime = this.PARAMS.INTEGRATIONTIME_700MS;
        const integrationTimeDelay = 700 + 300;
        // "ISO"
        const gain = this.PARAMS.GAIN_16X;
        ...
        const read8 = (reg, callback) => {
          io.i2cReadOnce(address, this.REGISTER.COMMAND_BIT | reg, 1, callback);
        };
        ...
        const disable = () => {
          ...
          write8(
            this.REGISTER.ENABLE,
            reg & ~(this.REGISTER.ENABLE_PON | this.REGISTER.ENABLE_AEN),
          );
        };
        ...
        const setInterrupt = (bool) => {
          // let r = 0x00; // read8(this.REGISTER.ENABLE);

          let r = isEnabled ? 0x00 : 0x01;

          if (bool) {
            r = r | this.REGISTER.ENABLE_AIEN;
          } else {
            r = r & ~this.REGISTER.ENABLE_AIEN;
          }
          write8(this.REGISTER.ENABLE, r);
        };
        ...
        const beginColorSensor = () => {
          ...
          write8(this.REGISTER.ATIME, integrationTime);

          // setGain(_tcs34725Gain);
          write8(this.REGISTER.CONTROL, gain);
